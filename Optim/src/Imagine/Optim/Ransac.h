...
/// minimize number of outliers) and leastMedianOfSquares (define outliers as quantile of worst
...
namespace Imagine {
	...
	class Estimator, class Residual, class Parameters>
		double leastMedianOfSquares(DataInputIterator first, DataInputIterator last,
		const Estimator& estimator, const Residual& residual,
		Parameters& bestParameters,
